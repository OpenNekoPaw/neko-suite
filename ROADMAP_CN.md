...
| **neko-types**   | Alpha  | 94%  | 共享类型 + 横切关注点统一 + Operations 类型安全 + **设备/追踪/预览契约 ✅** + **entity-uri 模块 ✅** + **storyboard-readiness 类型 ✅** + **分镜执行摘要 ✅**；后续 Layer 0 工具清理                                                                                                                                                                                                                                                                                      |
| **neko-client**  | Alpha  | 85%  | H264/fMP4/PCM 流客户端 + EngineClient HTTP dispatch + **设备客户端类（进行中）** + **感知门面 ✅** + **MediaPlaybackService ✅**（统一播放）                                                                                                                                                                                                                                                                                                                            |
