...
| **neko-canvas**  | Alpha  | 93%  | 13 种节点 + BatchGenerationScheduler + 7 MCP Tools；**P0 已全部收敛** ✅ + P1-1 CanvasEmbedNode + P1-4 NodeRendererRegistry + **NodeTypeDescriptor 注册表** ✅ + **场景-镜头缩略图模式 + 管理 UI ✅**；剩余 P1 增强（[ADR](./docs/architecture/canvas-role-boundary.md)）                                                                                                                                                                                            |
...
| **neko-types**   | Alpha  | 93%  | 共享类型 + 横切关注点统一 + Operations 类型安全 + **设备/追踪/预览契约 ✅**                                                                                                                                                                                                                                                                                                                                                                                           |
