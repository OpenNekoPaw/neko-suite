...
export const en = {
  ...
  'table.status.agent.parsing': 'Parsing',
  'table.status.agent.prompt-review': 'Prompt Review',
  'table.status.agent.pilot-review': 'Pilot Review',
  'table.status.agent.generating': 'Generating',
  'table.status.agent.timeline-arranged': 'Timeline Ready',
  'table.status.agent.failed': 'Failed',
  ...
  'table.action.startVideo': 'Start Video',
  'table.action.generateScene': 'Generate Scene',
