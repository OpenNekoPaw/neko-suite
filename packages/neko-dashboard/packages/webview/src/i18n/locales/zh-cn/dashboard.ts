...
export const dashboard = {
  ...
  'dashboard.skills.orchestrators': '编排技能',
  'dashboard.skills.standalone': '独立技能',
  'dashboard.skills.quickActions': '快捷动作',
  ...
  'dashboard.skills.role.orchestrator': '编排',
  'dashboard.skills.role.focused-skill': '子技能',
  'dashboard.skills.role.standalone': '独立',
  'dashboard.skills.role.quick-action': '动作',
  'dashboard.skills.role.persona': '角色',
