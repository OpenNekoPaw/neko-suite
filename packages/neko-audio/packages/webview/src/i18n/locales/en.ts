...
const audio: MessageBundle = {
  ...
  'audio.hostAdapter.dock': '{label} adapter',
  'audio.hostAdapter.package': 'Package',
  'audio.hostAdapter.panel': 'Panel',
  'audio.hostAdapter.runtime': 'Runtime',
  'audio.hostAdapter.file': 'File',
