...
export const zhCN = {
  ...
  'hostAdapter.orbit': '环绕',
  'hostAdapter.settings': '设置',
  'hostAdapter.sceneTrack': '场景 {name}',
  ...
  'viewport.quality.quarter': '性能',
  'viewport.quality.half': '清晰',
  'viewport.quality.native': '极清',
