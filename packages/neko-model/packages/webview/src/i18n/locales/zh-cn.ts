...
export const zhCN = {
  ...
  'performance.metric.presentFps': '呈现 FPS',
  'performance.metric.frameP95': '帧 P95',
  'performance.metric.gpuFrame': 'GPU 帧',
  'performance.metric.producerFrame': '生产帧',
  'performance.metric.encode': '编码',
  'performance.metric.streamSubmit': '提交',
  'performance.metric.scheduleLag': '调度滞后',
  'performance.metric.decode': '解码输出',
  'performance.metric.packetOutput': '包到输出',
  'performance.metric.outputPresent': '输出到呈现',
  'performance.metric.draw': '绘制',
  'performance.metric.queue': '队列',
  'performance.metric.webcodecsQueue': 'WebCodecs 队列',
  'performance.metric.pendingDecode': '待输出解码',
  'performance.metric.decodeOutputInterval': '输出间隔',
  'performance.metric.decodeOutputBurst': '输出突发',
  'performance.metric.preDecodeDrops': '解码前丢弃',
  'performance.metric.prePresentDrops': '呈现前丢弃',
  'performance.metric.decodeLag': '解码滞后帧',
  'performance.metric.ackP95': 'ACK P95',
  'performance.metric.patchBandwidth': '补丁带宽',
  'performance.metric.gpuUpload': 'GPU 上传',
  'performance.metric.frameDrops': '丢帧',
  'performance.metric.skippedIntervals': '跳过间隔',
