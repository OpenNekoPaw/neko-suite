...
export const en = {
  ...
  'performance.metric.presentFps': 'Present FPS',
  'performance.metric.frameP95': 'Frame P95',
  'performance.metric.gpuFrame': 'GPU frame',
  'performance.metric.producerFrame': 'Producer frame',
  'performance.metric.encode': 'Encode',
  'performance.metric.streamSubmit': 'Submit',
  'performance.metric.scheduleLag': 'Schedule lag',
  'performance.metric.decode': 'Decode output',
  'performance.metric.packetOutput': 'Packet to output',
  'performance.metric.outputPresent': 'Output to present',
  'performance.metric.draw': 'Draw',
  'performance.metric.queue': 'Queue',
  'performance.metric.webcodecsQueue': 'WebCodecs queue',
  'performance.metric.pendingDecode': 'Pending decode',
  'performance.metric.decodeOutputInterval': 'Output interval',
  'performance.metric.decodeOutputBurst': 'Output burst',
  'performance.metric.preDecodeDrops': 'Pre-decode drops',
  'performance.metric.prePresentDrops': 'Pre-present drops',
  'performance.metric.decodeLag': 'Decode lag frames',
  'performance.metric.ackP95': 'ACK P95',
  'performance.metric.patchBandwidth': 'Patch bandwidth',
  'performance.metric.gpuUpload': 'GPU upload',
  'performance.metric.frameDrops': 'Frame drops',
  'performance.metric.skippedIntervals': 'Skipped intervals',
