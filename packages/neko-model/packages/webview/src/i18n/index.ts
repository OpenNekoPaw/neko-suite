/**
 * i18n setup for neko-model webview
 *
 * Uses shared I18nService from @neko/shared.
 * Model editor has a single namespace with all keys in one flat bundle.
 */
...
// Register bundles
i18nService.registerBundle('model', 'en', en);
i18nService.registerBundle('model', 'zh-cn', zhCN);
