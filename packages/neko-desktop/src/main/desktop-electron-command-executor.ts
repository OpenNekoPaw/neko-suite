...
import {
  ...
  buildUserConfigTemplate,
  createOpenFilePlan,
  getUserConfigPath,
} from '@neko/platform';
import { getWorkspaceConfigPath } from '@neko/platform/config/index';
...
export interface ElectronDesktopCommandExecutorOptions {
...
interface DesktopProjectFileSearchPlan {
  readonly filter: string;
  readonly limit: number;
}

export function createElectronDesktopCommandExecutor(
  options: ElectronDesktopCommandExecutorOptions,
): NekoCommandExecutor {
...
async function searchElectronProjectFiles(
  ...
  plan: DesktopProjectFileSearchPlan,
...
function matchesSearchPlan(relativePath: string, plan: DesktopProjectFileSearchPlan): boolean {
...
function resolveOpenPath(projectFileIo: DesktopProjectFileIoAdapter, filePath: string): string {
