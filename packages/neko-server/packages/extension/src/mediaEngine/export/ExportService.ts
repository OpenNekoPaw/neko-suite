...
import { webTransformToRust } from '@uniedit/shared/utils/coordinateTransform';
...
export class ExportService {
	...
	async initialize(): Promise<void> {
		...
		try {
			// Load native module
			this._nativeModule = await import('@vedit/media-processor-rs') as unknown as NativeModuleType;
