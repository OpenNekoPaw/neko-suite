...
**Install:**
```bash
npm install @uniedit/effects-core
```

**Import:**
```typescript
// Types
import type { Keyframe, Transition, Effect, Mask, BlendModeType } from '@uniedit/effects-core';

// Algorithms
import { getEasingFunction, blendColors, rgbaToHsla } from '@uniedit/effects-core';

// Shaders (WGSL) - TS string exports
import { COMMON_WGSL, BLEND_MODE_WGSL } from '@uniedit/effects-core/shaders';

// Shaders (WGSL) - Load from .wgsl files
import { getCommonWgsl, getBlendModesWgsl } from '@uniedit/effects-core/shaders';
```
...
import { ... } from '@uniedit/effects-core';

// Subpath exports
import { ... } from '@uniedit/effects-core/shaders';
import { ... } from '@uniedit/effects-core/algorithms';
```
