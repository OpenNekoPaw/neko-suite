/**
 * Blend Mode WGSL Shaders
 *
 * Photoshop-compatible blend mode implementations.
...
// Component (require HSL conversion from common.wgsl)
...
// =============================================================================
// Main Blend Function with Opacity
// =============================================================================
