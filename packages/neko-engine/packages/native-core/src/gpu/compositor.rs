...
/// Blend mode values (must match shader)
/// Extended to 27 modes for full Web compatibility
#[repr(u32)]
...
impl BlendMode {
    pub fn from_str(s: &str) -> Self {
        match s.to_lowercase().as_str() {
            ...
            "darkercolor" | "darker_color" => BlendMode::DarkerColor,

            // Lighten Group
            "lighten" => BlendMode::Lighten,
            "screen" => BlendMode::Screen,
            "colordodge" | "color_dodge" => BlendMode::ColorDodge,
            "lineardodge" | "linear_dodge" | "add" => BlendMode::LinearDodge,
            "lightercolor" | "lighter_color" => BlendMode::LighterColor,
...
impl GpuCompositor {
    ...
    pub fn composite(
...

        {
            ...
            let workgroups_x = (output_width + 15) / 16;
            let workgroups_y = (output_height + 15) / 16;
