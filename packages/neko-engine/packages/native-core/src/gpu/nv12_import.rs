...
use crate::decoder::{GpuTextureHandle, Nv12GpuTexture};
...
impl Nv12TextureImporter {
    ...
    pub fn import(&self, gpu_texture: &Nv12GpuTexture) -> Result<ImportedNv12Texture> {
        match &gpu_texture.handle {
            #[cfg(target_os = "macos")]
            GpuTextureHandle::VideoToolbox {
                pixel_buffer,
                io_surface,
