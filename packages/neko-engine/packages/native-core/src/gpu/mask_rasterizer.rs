...
//!
//! Converts `ElementMask` geometry (rectangle, ellipse, polygon, bezier) into
...
use crate::domain::timeline::{ElementMask, MaskShapeData};
...
mod tests {
    ...
    fn test_extract_rectangle_params() {
        let shape = MaskShapeData::Rectangle {
            center_x: 960.0,
            center_y: 540.0,
            width: 400.0,
            height: 300.0,
    ...
    fn test_extract_polygon_params() {
        let shape = MaskShapeData::Polygon {
    ...
    fn test_polygon_vertex_limit() {
        ...
        let shape = MaskShapeData::Polygon { points };
