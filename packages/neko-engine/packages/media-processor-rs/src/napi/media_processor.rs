...
use crate::audio::{AudioDecoder, AudioEncoder, FfmpegAudioDecoder, FfmpegAudioEncoder};
use crate::decoder::{Decoder, HwAccelType, ZeroCopyDecoder};
use crate::encoder::{Encoder, HwAccelEncoder, HwEncoderType};
use crate::gpu::{
...
impl MediaProcessor {
    ...
    pub fn detect_hw_accel(&self) -> JsHwAccelInfo {
        use crate::decoder::detect_hw_accel;
        use crate::encoder::hwaccel::detect_hw_encoders;
    ...
    pub fn decode_frame_zerocopy(
        ...
        use crate::gpu::{ColorSpace, MacOsTextureImporter, Nv12Renderer};
        use crate::decoder::GpuTextureHandle;
    ...
    fn decode_frame_with_gpu_conversion(
        ...
        use crate::gpu::{ColorSpace, Nv12Renderer, Nv12TextureImporter};
    ...
    pub fn rgba_to_nv12(&self, frame: JsFrameData, color_space: Option<u32>) -> Result<JsFrameData> {
        use crate::gpu::RgbaToNv12Converter;
...
use crate::encoder::{FfmpegMuxer, Muxer};
...
use crate::animation::{AnimationTimeline, KeyframeTrack};
...
use crate::animation::AnimationPresets;
...
use crate::encoder::{AsyncExportPipeline, PipelineFrame};
...
use crate::frame_server::{FrameServer, FrameServerConfig, FrameServerHandle};
...
use crate::media_service::{extract_subtitles, probe_media_info};
...
///
/// Uses hardware-accelerated decoding (VideoToolbox/VAAPI/D3D11VA) with GPU
/// color conversion for optimal performance.
///
/// # Arguments
...
/// * JPEG image data as Buffer
#[napi]
pub fn extract_frame(source: String, time: f64, quality: Option<u32>) -> Result<Buffer> {
    use crate::decoder::{Decoder, HwAccelType, ZeroCopyDecoder};
