...
impl From<JsVideoCodec> for crate::encoder::VideoCodec {
    fn from(codec: JsVideoCodec) -> Self {
        match codec {
            JsVideoCodec::H264 => crate::encoder::VideoCodec::H264,
            JsVideoCodec::H265 => crate::encoder::VideoCodec::H265,
            JsVideoCodec::Vp9 => crate::encoder::VideoCodec::Vp9,
            JsVideoCodec::ProRes => crate::encoder::VideoCodec::ProRes,
        }
    }
}
...
impl From<JsContainerFormat> for crate::encoder::ContainerFormat {
    fn from(format: JsContainerFormat) -> Self {
        match format {
            JsContainerFormat::Mp4 => crate::encoder::ContainerFormat::Mp4,
            JsContainerFormat::Mkv => crate::encoder::ContainerFormat::Mkv,
            JsContainerFormat::WebM => crate::encoder::ContainerFormat::WebM,
            JsContainerFormat::Mov => crate::encoder::ContainerFormat::Mov,
        }
    }
}
...
impl From<JsEncoderPreset> for crate::encoder::EncoderPreset {
    fn from(preset: JsEncoderPreset) -> Self {
        match preset {
            JsEncoderPreset::Ultrafast => crate::encoder::EncoderPreset::Ultrafast,
            JsEncoderPreset::Fast => crate::encoder::EncoderPreset::Fast,
            JsEncoderPreset::Medium => crate::encoder::EncoderPreset::Medium,
            JsEncoderPreset::Slow => crate::encoder::EncoderPreset::Slow,
            JsEncoderPreset::Veryslow => crate::encoder::EncoderPreset::Veryslow,
        }
    }
}
...
impl JsEncoderConfig {
    ...
    pub fn to_encoder_config(&self) -> crate::encoder::EncoderConfig {
        let codec = match self.codec.to_lowercase().as_str() {
            "h265" | "hevc" => crate::encoder::VideoCodec::H265,
            "vp9" => crate::encoder::VideoCodec::Vp9,
            "prores" => crate::encoder::VideoCodec::ProRes,
            _ => crate::encoder::VideoCodec::H264,
        };

        let preset = match self.preset.as_deref() {
            Some("ultrafast") => crate::encoder::EncoderPreset::Ultrafast,
            Some("fast") => crate::encoder::EncoderPreset::Fast,
            Some("slow") => crate::encoder::EncoderPreset::Slow,
            Some("veryslow") => crate::encoder::EncoderPreset::Veryslow,
            _ => crate::encoder::EncoderPreset::Medium,
        };
        ...
        let hw_encoder = match self.hw_encoder.as_deref() {
            Some("auto") => crate::encoder::HwEncoderType::Auto,
            Some("videotoolbox") => crate::encoder::HwEncoderType::VideoToolbox,
            Some("nvenc") => crate::encoder::HwEncoderType::Nvenc,
            Some("vaapi") => crate::encoder::HwEncoderType::Vaapi,
            Some("qsv") => crate::encoder::HwEncoderType::Qsv,
            Some("none") | None => crate::encoder::HwEncoderType::None,
            Some(other) => {
                tracing::warn!("Unknown hw_encoder type: {}, using software", other);
                crate::encoder::HwEncoderType::None
            }
        };

        let mut config = crate::encoder::EncoderConfig::new(self.width, self.height, self.fps, codec)
...
impl From<&crate::encoder::EncodedPacket> for JsEncodedPacket {
    fn from(packet: &crate::encoder::EncodedPacket) -> Self {
        Self {
...
impl From<JsAudioCodec> for crate::audio::AudioCodec {
    fn from(codec: JsAudioCodec) -> Self {
        match codec {
            JsAudioCodec::Aac => crate::audio::AudioCodec::Aac,
            JsAudioCodec::Mp3 => crate::audio::AudioCodec::Mp3,
            JsAudioCodec::Opus => crate::audio::AudioCodec::Opus,
            JsAudioCodec::Flac => crate::audio::AudioCodec::Flac,
            JsAudioCodec::Pcm => crate::audio::AudioCodec::Pcm,
        }
    }
}
...
impl From<JsSampleFormat> for crate::audio::SampleFormat {
    fn from(format: JsSampleFormat) -> Self {
        match format {
            JsSampleFormat::U8 => crate::audio::SampleFormat::U8,
            JsSampleFormat::S16 => crate::audio::SampleFormat::S16,
            JsSampleFormat::S32 => crate::audio::SampleFormat::S32,
            JsSampleFormat::F32 => crate::audio::SampleFormat::F32,
            JsSampleFormat::F64 => crate::audio::SampleFormat::F64,
        }
    }
}

impl From<crate::audio::SampleFormat> for JsSampleFormat {
    fn from(format: crate::audio::SampleFormat) -> Self {
        match format {
            crate::audio::SampleFormat::U8 => JsSampleFormat::U8,
            crate::audio::SampleFormat::S16 => JsSampleFormat::S16,
            crate::audio::SampleFormat::S32 => JsSampleFormat::S32,
            crate::audio::SampleFormat::F32 => JsSampleFormat::F32,
            crate::audio::SampleFormat::F64 => JsSampleFormat::F64,
        }
    }
}
...
impl JsAudioEncoderConfig {
    ...
    pub fn to_audio_encoder_config(&self) -> crate::audio::AudioEncoderConfig {
        let codec = match self.codec.as_deref() {
            Some("mp3") => crate::audio::AudioCodec::Mp3,
            Some("opus") => crate::audio::AudioCodec::Opus,
            Some("flac") => crate::audio::AudioCodec::Flac,
            Some("pcm") => crate::audio::AudioCodec::Pcm,
            _ => crate::audio::AudioCodec::Aac,
        };

        let sample_format = match self.sample_format.as_deref() {
            Some("u8") => crate::audio::SampleFormat::U8,
            Some("s16") => crate::audio::SampleFormat::S16,
            Some("s32") => crate::audio::SampleFormat::S32,
            Some("f64") => crate::audio::SampleFormat::F64,
            _ => crate::audio::SampleFormat::F32,
        };

        let mut config = crate::audio::AudioEncoderConfig::new(
            self.sample_rate,
...
impl From<&crate::audio::AudioInfo> for JsAudioInfo {
    fn from(info: &crate::audio::AudioInfo) -> Self {
        Self {
...
impl From<&crate::audio::DecodedAudioFrame> for JsAudioFrame {
    fn from(frame: &crate::audio::DecodedAudioFrame) -> Self {
        Self {
...
impl From<&crate::audio::EncodedAudioPacket> for JsEncodedAudioPacket {
    fn from(packet: &crate::audio::EncodedAudioPacket) -> Self {
        Self {
            data: Buffer::from(packet.data.clone()),
            pts: packet.pts,
            duration: packet.duration,
...
impl JsMuxerConfig {
    ...
    pub fn container_format(&self) -> crate::encoder::ContainerFormat {
        match self.format.to_lowercase().as_str() {
            "mkv" | "matroska" => crate::encoder::ContainerFormat::Mkv,
            "webm" => crate::encoder::ContainerFormat::WebM,
            "mov" => crate::encoder::ContainerFormat::Mov,
            _ => crate::encoder::ContainerFormat::Mp4,
        }
    }
}
...
impl From<&crate::encoder::StreamInfo> for JsStreamInfo {
    fn from(info: &crate::encoder::StreamInfo) -> Self {
        Self {
...
impl JsMuxerPacket {
    ...
    pub fn to_encoded_packet(&self, stream_index: usize) -> crate::encoder::EncodedPacket {
        crate::encoder::EncodedPacket {
...
use crate::gpu::{BlendMode as RustBlendMode, Transform2D as RustTransform2D};
...
impl From<JsCompositeLayer> for crate::gpu::CompositeLayer {
    fn from(layer: JsCompositeLayer) -> Self {
        use crate::gpu::LayerPixelFormat;
...
impl From<crate::gpu::CompositeResult> for JsCompositeResult {
    fn from(result: crate::gpu::CompositeResult) -> Self {
        Self {
...
impl JsPipelineConfig {
    ...
    pub fn to_pipeline_config(&self) -> crate::encoder::PipelineConfig {
        let container = match self.container.as_deref() {
            Some("mkv") | Some("matroska") => crate::encoder::ContainerFormat::Mkv,
            Some("webm") => crate::encoder::ContainerFormat::WebM,
            Some("mov") => crate::encoder::ContainerFormat::Mov,
            _ => crate::encoder::ContainerFormat::Mp4,
        };

        crate::encoder::PipelineConfig {
...
impl From<&crate::encoder::PipelineProgress> for JsPipelineProgress {
    fn from(progress: &crate::encoder::PipelineProgress) -> Self {
...
impl From<JsPipelineFrame> for crate::encoder::PipelineFrame {
