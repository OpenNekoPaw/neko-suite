              ...
              >
                <div className="flex items-center gap-1 min-w-0">
                  ...
                  {track.type === 'text' && (
                    <svg className="w-3 h-3 text-yellow-400 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 0h8v2H6V4zm8 4H6v2h8V8zm-4 4H6v2h4v-2z" clipRule="evenodd" />
                    </svg>
                  )}
                  {track.type === 'audio' && (
                ...
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    title={track.muted ? t('timeline.contextMenu.unmuteTrack') : t('timeline.contextMenu.muteTrack')}
                  >
                    {track.muted ? (
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
