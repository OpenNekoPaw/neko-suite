...
export function useAssetLibrary(): UseAssetLibraryReturn {
  ...
  const createEntity = useCallback(
    async (input: CreateEntityInput): Promise<AssetEntity> => {
  ...
  const updateEntity = useCallback(
    async (id: string, updates: UpdateEntityInput): Promise<AssetEntity> => {
      const entity = await sendRequest<AssetEntity>({
  ...
  const addVariant = useCallback(
    async (entityId: string, input: CreateVariantInput): Promise<AssetVariant> => {
  ...
  const deleteVariant = useCallback(
    async (entityId: string, variantId: string): Promise<boolean> => {
  ...
  const moveVariant = useCallback(
    async (input: MoveVariantInput): Promise<MoveVariantResult> => {
  ...
  const mergeEntities = useCallback(
    async (input: MergeEntitiesInput): Promise<MergeEntitiesResult> => {
  ...
  const importByPaths = useCallback(
    async (paths: string[]) => {
