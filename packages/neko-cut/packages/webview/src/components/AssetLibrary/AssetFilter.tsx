...
const EXPRESSION_OPTIONS: ExpressionState[] = [
  'neutral',
  'happy',
  'sad',
  'angry',
...
const ACTION_OPTIONS: ActionState[] = [
  'idle',
  'walk',
  'run',
  'jump',
...
const FilterSection = memo(function FilterSection({
  ...
  return (
    <div className="space-y-1.5">
      <div className="text-xs font-medium" style={{ color: 'var(--vscode-foreground)' }}>
        {title}
      </div>
...
export const AssetFilter = memo(function AssetFilter({
  ...
  const getExpressionLabel = useCallback(
    (expression: string) => {
  ...
  return (
    <div className="border-b" style={{ borderColor: 'var(--vscode-sideBarSectionHeader-border)' }}>
      {/* Header */}
      <button
