...
Gather generated media refs, validate provenance, and summarize what can be assembled. Use timeline or Canvas capabilities only when the target is available and the user wants delivery.
