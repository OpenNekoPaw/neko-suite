/**
 * i18n setup for neko-sketch webview
 *
 * Uses shared I18nService from @neko/shared.
 * Sketch has a single namespace with all keys in one flat bundle.
 */
...
// Register bundles
i18nService.registerBundle('sketch', 'en', en);
i18nService.registerBundle('sketch', 'zh-cn', zhCN);
