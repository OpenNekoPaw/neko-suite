...
describe('checkStructure', () => {
	...
	it('reports duplicate track names', () => {
		const project = parse({
			...
			fps: 30,
			tracks: [
				{ id: 't1', name: 'Same Name', track_type: 'video', elements: [{ Media: { id: 'e1', name: 'a', duration: 1, start_time: 0 } }] },
				{ id: 't2', name: 'Same Name', track_type: 'audio', elements: [{ Audio: { id: 'e2', name: 'b', duration: 1, start_time: 0 } }] },
			],
		});
	...
	it('reports empty tracks', () => {
		const project = parse({
			...
			fps: 30,
			tracks: [
				{ id: 't1', name: 'Empty Track', track_type: 'video', elements: [] },
			],
		});
			...
			tracks: [
				{
					...
					track_type: 'text',
					elements: [
						{ Text: { id: 'e1', name: 'Title', duration: 5, start_time: 0 } },
					],
				},
			],
		});
