...
// Editor exports
export { AssetVariantDiffEditorProvider, AssetVariantDiffFileSystemProvider } from './editor/AssetVariantDiffEditorProvider';
...
export function initializeAssetDiff(
	...
	context.subscriptions.push(
		vscode.workspace.registerFileSystemProvider(
			AssetVariantDiffEditorProvider.scheme,
			fsProvider,
