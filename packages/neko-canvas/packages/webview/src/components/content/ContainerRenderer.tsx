...
function SceneShotTableImageCell({
  ...
  if (!row.hasImage && previewSource.renderForm === 'asset-thumbnail') {
    return (
      <div
        className="flex h-[220px] max-w-[300px] items-center justify-center rounded border border-dashed border-gray-200 bg-gray-50 px-2 text-[10px] text-gray-400"
  ...
  return (
    <div
      className="inline-flex max-h-[220px] max-w-[300px] overflow-hidden rounded border border-gray-200 bg-gray-50 align-top"
      data-scene-shot-image-preview="large"
    >
      <CardPreviewSlot
