...
export const BUILT_IN_CANVAS_NODE_PRESETS = [
  ...
  },
  {
    ...
    deriveTargets: ['shot.basic', 'gallery.basic', 'annotation.basic', 'text.basic'],
  },
  {
    name: 'scene.basic',
    nodeType: 'scene',
    ...
    deriveTargets: ['scene.basic', 'shot.basic', 'gallery.basic', 'annotation.basic', 'text.basic'],
  },
  {
    name: 'gallery.basic',
    nodeType: 'gallery',
    ...
    deriveTargets: ['gallery.basic', 'shot.basic', 'annotation.basic', 'text.basic'],
  },
  {
    name: 'media.basic',
    nodeType: 'media',
    ...
    deriveTargets: ['media.basic', 'annotation.basic', 'text.basic'],
  },
  {
    ...
    creationMode: 'legacy',
    label: 'Storyboard',
    deriveTargets: ['storyboard.legacy', 'shot.basic', 'annotation.basic', 'text.basic'],
  },
  {
