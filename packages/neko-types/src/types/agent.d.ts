...
import type { IPlatform, IService, ChatMessage, LLMProviderConfig, ToolDefinition, ServiceOptions } from './platform';
/**
...
export interface ExecutorHooks {
    ...
    onToolCall?(info: ToolCallInfo, execute: () => Promise<ToolResult>): Promise<ToolResultWithMeta | null>;
}
/**
