 ...
 */
import type { AssetEntity, AssetFile, AssetVariant, CreateEntityInput, CreateVariantInput, EntityCategory, UpdateEntityInput, UpdateVariantInput, AddFileOptions, MoveVariantInput, MoveVariantResult, MergeEntitiesInput, MergeEntitiesResult } from './entity';
...
export type AssetRequest = CreateEntityRequest | GetEntityRequest | UpdateEntityRequest | DeleteEntityRequest | SearchAssetsRequest | GetByCategoryRequest | GetByTagsRequest | GetRecentRequest | AddVariantRequest | UpdateVariantRequest | DeleteVariantRequest | AddFileRequest | RemoveFileRequest | ClassifyFileRequest | FindSimilarRequest | ImportFileRequest | GetAllTagsRequest | RecordUsageRequest | MoveVariantRequest | MergeEntitiesRequest | CompareVariantsRequest;
...
export type AssetResponse = EntityCreatedResponse | EntityLoadedResponse | EntityUpdatedResponse | EntityDeletedResponse | SearchResultResponse | EntitiesListResponse | VariantAddedResponse | VariantUpdatedResponse | VariantDeletedResponse | FileAddedResponse | FileRemovedResponse | ClassifyResultResponse | SimilarEntitiesResponse | ImportResultResponse | AllTagsResponse | UsageRecordedResponse | VariantMovedResponse | EntitiesMergedResponse | AssetErrorResponse;
export {};
