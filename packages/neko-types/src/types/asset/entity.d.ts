...
export type EntityCategory = 'character' | 'creature' | 'object' | 'vehicle' | 'environment' | 'effect' | 'ui' | 'audio';
/** View angle dimension */
export type ViewAngle = 'front' | 'back' | 'left' | 'right' | 'top' | 'bottom' | 'isometric' | '3/4';
/** Expression/emotion state */
export type ExpressionState = 'neutral' | 'happy' | 'sad' | 'angry' | 'surprised' | 'talking' | 'sleeping' | 'custom';
/** Action/animation state */
export type ActionState = 'idle' | 'walk' | 'run' | 'jump' | 'attack' | 'sit' | 'lie' | 'custom';
/** Texture/material type */
export type TextureType = 'diffuse' | 'normal' | 'roughness' | 'metallic' | 'emission' | 'alpha' | 'ao';
/** Time of day */
...
export type FilePurpose = 'main' | 'thumbnail' | 'preview' | 'texture' | 'reference' | 'source';
/** Media file type */
