...
export type AssetDiffViewMode = 'side-by-side' | 'slider' | 'overlay' | 'onion-skin' | 'difference' | 'heatmap';
...
/** Types of changes */
export type AssetChangeType = 'dimension' | 'color' | 'content' | 'quality' | 'duration' | 'audio' | 'metadata' | 'format';
...
export type AssetDiffRequestMessage = {
    type: 'assetDiff:compare';
    payload: AssetDiffRequest;
} | {
    type: 'assetDiff:compareWithGit';
    payload: {
        filePath: string;
        ref?: string;
    };
    ...
    type: 'assetDiff:getVersionHistory';
    payload: {
        filePath: string;
    };
} | {
    type: 'assetDiff:generateAIReport';
    payload: {
...
export type AssetDiffResponseMessage = {
    ...
    payload: AssetDiffResult;
} | {
    type: 'assetDiff:progress';
    payload: {
        progress: number;
        stage: string;
    };
} | {
    type: 'assetDiff:variantComparison';
    payload: VariantComparisonResult;
} | {
    type: 'assetDiff:versionHistory';
    payload: FileVersion[];
} | {
    type: 'assetDiff:aiReport';
    payload: string;
} | {
