 ...
 */
export declare const DEFAULT_INJECTION_CONFIG: ToolInjectionConfig;
/**
 ...
 */
export type InjectionEventType = 'tool_injected' | 'tool_removed' | 'skill_activated' | 'skill_deactivated' | 'budget_exceeded' | 'state_reset';
/**
 * Injection event
 */
...
//# sourceMappingURL=tool-injection.d.ts.map