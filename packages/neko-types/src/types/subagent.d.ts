 ...
 */
export type SubAgentUIStatus = 'pending' | 'running' | 'completed' | 'failed' | 'cancelled';
/**
 * SubAgent type (specialized or general)
 */
export type SubAgentUIType = 'code-search' | 'file-explorer' | 'test-runner' | 'document-writer' | 'general';
/**
