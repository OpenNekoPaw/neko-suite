/** Effect category */
export type EffectCategory = 'blur' | 'sharpen' | 'distort' | 'stylize' | 'color' | 'generate' | 'keying' | 'utility';
/** Effect parameter type */
export type EffectParameterType = 'number' | 'boolean' | 'color' | 'select' | 'point' | 'angle' | 'range';
...
export type EffectType = 'blur' | 'gaussian-blur' | 'motion-blur' | 'radial-blur' | 'sharpen' | 'noise' | 'glow' | 'chromaKey' | 'chroma-key' | 'lumaKey' | 'luma-key' | 'chromaticAberration' | 'chromatic-aberration' | 'filmGrain' | 'vignette';
