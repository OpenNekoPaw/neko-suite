 ...
 */
export type Shape = RectangleShape | EllipseShape | PolygonShape | StarShape | LineShape | BezierShape;
/**
...
export declare const DEFAULT_SHAPE_FILL: ShapeFill;
export declare const DEFAULT_SHAPE_STROKE: ShapeStroke;
export declare const DEFAULT_SHAPE_SHADOW: ShapeShadow;
export declare const DEFAULT_SHAPE_STYLE: ShapeStyle;
export {};
