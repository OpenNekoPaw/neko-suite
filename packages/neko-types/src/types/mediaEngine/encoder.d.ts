 ...
 */
export declare function isStreamingEncoder(encoder: IEncoder): encoder is IStreamingEncoder;
/**
 * Check if an encoder is an audio encoder
 */
export declare function isAudioEncoder(encoder: unknown): encoder is IAudioEncoder;
