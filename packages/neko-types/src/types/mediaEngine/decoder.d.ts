...
export interface IDecoder {
     ...
     */
    decodeRange(startTime: number, duration: number, fps?: number): AsyncGenerator<DecodedFrame, void, undefined>;
    /**
...
export interface IVideoDecoder extends IDecoder {
     ...
     */
    decodeRange(startTime: number, duration: number, fps: number): AsyncGenerator<DecodedVideoFrame, void, undefined>;
    /**
...
export interface IAudioDecoder extends IDecoder {
     ...
     */
    decodeRange(startTime: number, duration: number): AsyncGenerator<DecodedAudioFrame, void, undefined>;
    /**
 ...
 */
export declare function isVideoFrame(frame: DecodedFrame): frame is DecodedVideoFrame;
/**
 * Check if a decoded frame is an audio frame
 */
export declare function isAudioFrame(frame: DecodedFrame): frame is DecodedAudioFrame;
/**
 * Check if a decoder is a video decoder
 */
export declare function isVideoDecoder(decoder: IDecoder): decoder is IVideoDecoder;
/**
 * Check if a decoder is an audio decoder
 */
export declare function isAudioDecoder(decoder: IDecoder): decoder is IAudioDecoder;
