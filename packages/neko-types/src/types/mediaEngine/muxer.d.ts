 ...
 * Muxer state
 */
export type MuxerState = 'idle' | 'initializing' | 'muxing' | 'finalizing' | 'completed' | 'error' | 'cancelled';
/**
 ...
 */
export declare function isVideoChunk(chunk: MuxerVideoChunk | MuxerAudioChunk): chunk is MuxerVideoChunk;
/**
 * Check if a chunk is an audio chunk
 */
export declare function isAudioChunk(chunk: MuxerVideoChunk | MuxerAudioChunk): chunk is MuxerAudioChunk;
