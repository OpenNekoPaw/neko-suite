 ...
 */
export type ProviderType = 'openai' | 'anthropic' | 'google' | 'azure' | 'ollama' | 'generic' | 'xai' | 'kling' | 'runway' | 'luma' | 'minimax' | 'jimeng' | 'liblib' | 'suno' | 'vidu' | 'midjourney';
/**
 ...
 * Model capabilities
 */
export type ModelCapability = 'chat' | 'completion' | 'vision' | 'function_calling' | 'json_mode' | 'streaming' | 'embedding' | 'code' | 'audio' | 'text_to_image' | 'image_to_image' | 'text_to_video' | 'image_to_video' | 'video_to_video' | 'text_to_audio' | 'text_to_music' | 'workflow' | 'image_generation' | 'video_generation';
/**
 * Model configuration
 */
...
export type MCPServerCategory = 'filesystem' | 'database' | 'api' | 'development' | 'productivity' | 'ai' | 'other';
...
export type WorkflowEngineType = 'comfyui' | 'dify' | 'n8n' | 'make' | 'zapier' | 'langflow' | 'flowise' | 'custom';
...
export type PromptPresetType = 'chat' | 'coder' | 'screenwriter' | 'storyboard' | 'image' | 'video' | 'audio' | 'plan' | 'custom';
/**
