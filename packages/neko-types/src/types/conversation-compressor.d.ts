 ...
 */
export declare const DEFAULT_COMPRESSOR_CONFIG: ConversationCompressorConfig;
/**
...
export interface IConversationCompressor {
     ...
     */
    compress(messages: ChatMessage[], options?: {
...
//# sourceMappingURL=conversation-compressor.d.ts.map