 ...
 */
export declare const DEFAULT_LAYERED_CONTEXT_MANAGER_CONFIG: LayeredContextManagerConfig;
/**
 * Context event types
 */
export type ContextEventType = 'item_added' | 'item_removed' | 'item_accessed' | 'layer_overflow' | 'compression_triggered' | 'compression_completed' | 'skill_activated' | 'skill_deactivated' | 'turn_started' | 'turn_ended' | 'state_reset';
/**
 * Context event
 */
