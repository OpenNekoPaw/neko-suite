 ...
 */
import type { ProviderConfig, ModelConfig, MCPServerConfig, WorkflowConfig, PromptPresetConfig } from '../types/config';
/**
 ...
 */
export declare const DEFAULT_CONFIG: Omit<NormalizedConfig, 'providers' | 'models' | 'groups' | 'mcpServers' | 'workflows' | 'prompts' | 'templates'>;
/** Config directory name */
export declare const CONFIG_DIR_NAME = ".neko";
/** Config file name */
