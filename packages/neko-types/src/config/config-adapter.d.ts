 ...
 */
export declare abstract class BaseConfigAdapter<T> implements IConfigAdapter<T> {
    /**
     * Convert from UnifiedConfig to target format
 ...
 */
export type ConfigChangeType = 'provider' | 'model' | 'mcp' | 'workflow' | 'prompt' | 'skill' | 'hook' | 'full';
/**
