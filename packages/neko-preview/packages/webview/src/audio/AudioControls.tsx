...
export function AudioControls({
  ...
  return (
    <div tabIndex={0} onKeyDown={handleKeyDown} style={{ width: '100%', outline: 'none' }}>
      {/* Progress bar */}
      <div className="audio-player__progress">
        <ProgressBar
          ...
          onSeeking={onScrub}
        />
        <div className="audio-player__progress-times">
      ...
      <div className="audio-player__controls">
        {/* Skip backward 10s */}
        <button
          className="audio-player__ctrl-btn audio-player__ctrl-btn--skip"
        ...
        {/* Play / Pause */}
        <button
          className="audio-player__ctrl-btn audio-player__ctrl-btn--play"
        ...
        >
          {isPlaying ? (
            ...
            <svg viewBox="0 0 24 24" className="icon-play">
      ...
      {/* Bottom bar: volume | view tabs | speed */}
      <div className="audio-player__bottom-bar">
        {/* Volume */}
        ...
        {/* View mode tabs */}
        <div className="audio-player__view-tabs">
          <button
            className={`audio-player__view-tab ${viewMode === 'cover' ? 'audio-player__view-tab--active' : ''}`}
          ...
          <button
            className={`audio-player__view-tab ${viewMode === 'lyrics' ? 'audio-player__view-tab--active' : ''}`}
          ...
          <button
            className={`audio-player__view-tab ${viewMode === 'waveform' ? 'audio-player__view-tab--active' : ''}`}
