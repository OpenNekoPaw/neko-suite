...
export const chat = {
  ...
  'chat.sessionMode.agentDesc':
    'Develop stories, characters, dialogue, narration, storyboard rhythm, and shot language directly with the Agent.',
  ...
  'chat.sessionMode.videoDesc': 'Create shot clips, motion previews, and atmospheric video assets.',
