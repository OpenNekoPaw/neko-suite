...
export const promptTemplates = {
  ...
  'promptTemplates.templates.trimSilence.prompt': 'Please analyze the selected video clip, find parts where audio is silent for more than {{threshold}} seconds, and help me trim these silent parts.',
  ...
  'promptTemplates.templates.autoSubtitles.description': 'Generate subtitles for selected video clip',
  'promptTemplates.templates.autoSubtitles.prompt': 'Please generate subtitles for the selected video clip. Use {{language}} language, with {{style}} style.',
  ...
  'promptTemplates.templates.matchCut.prompt': 'Please analyze the audio track beats and auto-split video track clips at each beat point to create edits matching the music rhythm.',
  ...
  'promptTemplates.templates.colorCorrection.prompt': 'Please analyze the selected video colors and provide color correction suggestions. Target style: {{style}}.',
  ...
  'promptTemplates.templates.generateBRoll.description': 'Generate supplementary footage based on main video content',
  'promptTemplates.templates.generateBRoll.prompt': 'Analyze the current video content and generate suitable B-Roll supplementary footage for the following time range: {{timeRange}}. Style requirements: {{style}}.',
  ...
  'promptTemplates.templates.generateThumbnail.description': 'Generate attractive cover image for video',
  'promptTemplates.templates.generateThumbnail.prompt': 'Please generate an attractive cover image based on the current video content. Requirements: {{requirements}}.',
  ...
  'promptTemplates.templates.generateTransition.description': 'Generate smooth transition effects between adjacent clips',
  'promptTemplates.templates.generateTransition.prompt': 'Please generate suitable transition effects between the selected {{count}} adjacent video clips. Transition type: {{transitionType}}.',
  ...
  'promptTemplates.templates.analyzePacing.description': 'Analyze video editing rhythm and provide optimization suggestions',
  'promptTemplates.templates.analyzePacing.prompt': 'Please analyze the current project\'s editing rhythm, including: 1) Clip duration distribution 2) Transition frequency 3) Shot type changes. And provide optimization suggestions.',
  'promptTemplates.templates.checkContinuity.name': 'Check Continuity',
  'promptTemplates.templates.checkContinuity.description': 'Check visual continuity between video clips',
  'promptTemplates.templates.checkContinuity.prompt': 'Please check the visual continuity between adjacent clips on the current timeline, find possible jump cuts or inconsistent places.',
  ...
  'promptTemplates.templates.analyzeAudio.prompt': 'Please analyze the current video audio track, check: 1) Volume balance 2) Any noise 3) Voice clarity. And provide improvement suggestions.',
  ...
  'promptTemplates.templates.contentSummary.prompt': 'Please analyze the current video content and generate a brief summary, including: theme, key scenes, duration and suitable platform suggestions.',
