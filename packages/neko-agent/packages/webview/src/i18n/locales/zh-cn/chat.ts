...
export const chat = {
  ...
  'chat.emptyState.description':
    '陪你完成故事、角色、分镜、镜头、画面、视频与声音创作。可以从项目素材出发，一起发展剧情、对白、旁白、场景设定和镜头表达，也能产出角色图、场景图、镜头片段、配音、音效和环境声。',
  'chat.emptyState.disclaimer': 'AI 回复可能不准确。',
  'chat.emptyState.suggestion1': '为这个故事设计主角和关系',
  'chat.emptyState.suggestion2': '把这个场景梳理成分镜节奏',
  'chat.emptyState.suggestion3': '设计一段对白与旁白',
