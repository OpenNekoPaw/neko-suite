...
export const chat = {
  ...
  'chat.skill.slot.workflowSkill': '工作流技能',
  'chat.skill.owner.user': '用户',
  'chat.skill.owner.agent': 'Agent',
  'chat.skill.owner.idc': 'IDC 阶段',
  'chat.skill.owner.runtime': '运行时',
  'chat.skill.provenance.user-explicit': '用户触发',
  'chat.skill.provenance.agent-tool': 'Agent 请求',
  'chat.skill.lockedReason.idcStagePersonaStageExit': '随所属 IDC 阶段退出自动清理',
  'chat.activation.target.skill': '技能',
  'chat.activation.target.idc-workflow': 'IDC 工作流',
  'chat.activation.target.idc-stage': 'IDC 阶段',
