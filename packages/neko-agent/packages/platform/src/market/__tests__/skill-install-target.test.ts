...
import { SkillInstallTarget, injectMarketFrontmatter } from '../index';
...
describe('SkillInstallTarget', () => {
  ...
  it('injects source and market id into existing frontmatter', () => {
    expect(
      injectMarketFrontmatter(
        `---
name: camera-shot
description: Build camera shot prompts
---
...
`,
    ...
    ).toContain(`source: market
market-id: "@pub/camera-shot"`);
  });

  it('updates existing market metadata instead of duplicating fields', () => {
