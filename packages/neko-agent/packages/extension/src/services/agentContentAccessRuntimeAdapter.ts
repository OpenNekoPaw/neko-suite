...
import type { ContentAccessService } from '@neko/shared/vscode/extension';
import {
...
export interface CreateExtensionAgentContentAccessRuntimeAdapterOptions {
...
export function createExtensionAgentContentAccessRuntimeAdapter(
  options: CreateExtensionAgentContentAccessRuntimeAdapterOptions,
): AgentContentAccessRuntime {
  return new ExtensionAgentContentAccessRuntime(options);
}
...
class ExtensionAgentContentAccessRuntime implements AgentContentAccessRuntime {
  ...
  constructor(
    private readonly services: CreateExtensionAgentContentAccessRuntimeAdapterOptions,
  ) {
