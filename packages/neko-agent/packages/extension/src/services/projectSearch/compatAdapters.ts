...
import { buildProjectSearchText, matchesProjectSearchItem } from './normalization';
...
export function createCompatibilityProjectSearchAdapters(
  ...
  const jsonReader = options.jsonReader ?? new VscodeJsonReader();
  return [
