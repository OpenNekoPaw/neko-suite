...
export interface RenderEngineStageDeps {
   ...
   */
  renderAnchor: (shotId: string, ctx: WorkflowContext) => Promise<readonly string[] | undefined>;
 ...
 */
export function collectAnchorShotIds(ctx: WorkflowContext): string[] {
...
export function createRenderEngineStage(deps: RenderEngineStageDeps): IWorkflowStage {
  return {
    name: 'renderEngine',
    type: 'linear',
    gate: 'auto',
