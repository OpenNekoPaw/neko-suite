 ...
 *
 * Usage:
 *   const registry = createWorkflowHookRegistry();
...
const logger = getLogger('WorkflowHookRegistry');
 ...
 */
export function createWorkflowHookRegistry(): WorkflowHookRegistry {
  return new WorkflowHookRegistry();
}
