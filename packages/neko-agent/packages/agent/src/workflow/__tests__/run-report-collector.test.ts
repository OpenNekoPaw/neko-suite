...
import type { WorkflowEvent, WorkflowContext } from '../types';

// =============================================================================
// Helpers
// =============================================================================

async function* eventStream(events: WorkflowEvent[]): AsyncIterable<WorkflowEvent> {
...
describe('createReportCollector', () => {
  it('should produce same result as collectRunReport for identical events', async () => {
    const ctx: WorkflowContext = { generatedPaths: ['/a.mp4'] };
