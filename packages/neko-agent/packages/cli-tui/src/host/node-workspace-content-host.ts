...
export function readNodeWorkspaceContentPolicy(input: {
...
export function readNodeWorkspaceContentPathVariables(input: {
  readonly workspaceRoot: string;
  readonly basePathVariables: PathVariableMap | ReadonlyMap<string, string>;
}): PathVariableMap {
  return readNodeWorkspaceContentSnapshot(input).mediaLibraryPathVariables;
}

export function readNodeWorkspaceContentSnapshot(input: {
  readonly workspaceRoot: string;
  readonly basePathVariables: PathVariableMap | ReadonlyMap<string, string>;
