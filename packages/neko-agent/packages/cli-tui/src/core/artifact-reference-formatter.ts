...
export function referencesFromArtifactTransfer(
...
export function referenceFromCompositeArtifact(
...
export function isStableResourceRef(value: unknown): value is ResourceRef {
