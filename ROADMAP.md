...
_Last updated: 2026-04-26 (Architecture docs cleanup: obsolete workflow/capability exploration docs removed from active references; current entry points are Agent Unified Workflow + Capability Protocol.)_
