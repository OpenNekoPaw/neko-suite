...
| NKS-008 | P2 | fixed | i18n 基础设施已搭建但大量 UI 文案硬编码，国际化一致性不足 |
...
| 编号 | 严重级别 | 状态 | 问题摘要 |
|---|---|---|---|
| NKAS-001 | P1 | fixed | 对外宣称 `cloud sync / CI/CD auto-rendering`，实际仍是占位命令 |
| NKAS-002 | P1 | fixed | 已贡献 `neko.cloudSync` 视图，但 Extension 未注册对应 Provider |
