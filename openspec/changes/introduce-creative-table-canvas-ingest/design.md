...
9. Run focused unit/contract tests, affected package typechecks, OpenSpec strict validation, and a real VS Code Webview functional scenario for the button/action loop.
