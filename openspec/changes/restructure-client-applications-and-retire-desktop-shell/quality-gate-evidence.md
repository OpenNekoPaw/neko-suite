...
| `pnpm test:agent:eval`                                                                | Passed: 40 files, 271 tests; strict discovery validated 26 suites and 38 cases. This is key-free harness evidence, not real Agent acceptance.                                      |
