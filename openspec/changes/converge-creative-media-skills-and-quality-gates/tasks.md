...
- [ ] 7.1 Implement or adapt `.nks` ProjectQuality facade for schema/version, resources, layer/frame integrity, revision, preview, and export readiness.
...
- [ ] 8.1 Define workflow run/stage state using existing Agent task and generated-asset lifecycle services with stable stage artifact references and diagnostics.
...
- [ ] 9.4 Implement bounded, observable migration aliases for approved legacy Skill names and record replacement diagnostics/telemetry.
...
- [ ] 9.7 Add legacy debt and unused-code assertions proving removed names and path-only Quality entry points cannot return default success.
