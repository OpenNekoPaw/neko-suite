# video-content-index-foundation Specification

## Purpose
Define the P0 `VideoContentIndex` contract used to store time-coded video evidence, quality issues, continuity edges, and source references before any edit-plan generation layer consumes them.
## Requirements
