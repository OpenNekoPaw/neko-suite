# canvas-spatial-groups Specification

## Purpose

Define manual spatial Group rendering, membership, coordinate, layout, and collapse semantics for real Canvas child nodes.
