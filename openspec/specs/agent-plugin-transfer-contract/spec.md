# agent-plugin-transfer-contract Specification

## Purpose
Define typed Agent-to-plugin transfer contracts for structured content, media assets, Canvas/Cut storyboards, destination targeting, and transfer safety policy.
## Requirements
