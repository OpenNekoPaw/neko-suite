# character-asset-dimension-registry Specification

## Purpose
Define character asset dimensions for puppet/model bundles, bundle-memory asset files, and searchable dimension metadata.
## Requirements
