# engine-kernel-service-facade-abstraction Specification

## Purpose
TBD - created by archiving change abstract-engine-kernel-service-facade. Update Purpose after archive.
## Requirements
