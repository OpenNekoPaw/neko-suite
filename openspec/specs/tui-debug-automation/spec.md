# tui-debug-automation Specification

## Purpose

Define the local developer automation boundary that drives the canonical TUI Agent session through a typed stdio protocol while keeping evaluation orchestration in repository scripts.
