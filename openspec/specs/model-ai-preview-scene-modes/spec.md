# model-ai-preview-scene-modes Specification

## Purpose
Define semantic AI character preview scene modes, camera/render presets, overlays, diagnostics, and provider routing.
## Requirements
