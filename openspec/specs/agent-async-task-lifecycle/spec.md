# agent-async-task-lifecycle Specification

## Purpose
Defines durable lifecycle guarantees for Neko Agent async tasks across Chat Webview rebuilds, Extension Host shutdown and restart, external provider recovery, Agent interruption, task result replay, and Dashboard visibility.
## Requirements
