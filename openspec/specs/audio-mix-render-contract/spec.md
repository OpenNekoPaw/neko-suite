# audio-mix-render-contract Specification

## Purpose
Defines the contract for building Engine-facing audio render instructions from
Extension-owned project metadata, path resolution, and canonical effect data.
## Requirements
