# resource-cache-service Specification

## Purpose
Define stable resource cache references, provider materialization, Webview projection, manifest freshness, quotas, and legacy migration behavior.
## Requirements
