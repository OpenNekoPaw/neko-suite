# storyboard-execution-summary Specification

## Purpose

Define the read-only Canvas storyboard execution summary contract used by Story and Agent. The summary lets consumers inspect scene and shot execution progress without depending on Canvas Webview internals or turning Story into a second storyboard editor.
